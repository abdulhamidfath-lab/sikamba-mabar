  ...
  try {
    ...
    sidebarEl.innerHTML = `
      ...
      <div class="admin-sidebar-section">
        ...
        <a href="produk-saya.html"        class="admin-sidebar-link" data-page="produk-saya"><span class="si">📦</span>Kelola Produk</a>
        <a href="kelola-dokumen.html"     class="admin-sidebar-link" data-page="kelola-dokumen"><span class="si">📋</span>Kelola Dokumen</a>
